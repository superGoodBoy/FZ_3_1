...
class Inter_interface(unittest.TestCase):
    ...
    def login(self):
        ...
        driver.find_element_by_css_selector(
            "#situationAnalysis>div.swiper-slide.icon-h-w.swiper-slide-next>div").click()
        self.driver.implicitly_wait(30)
    ...
    def test_top10_area(self):
        ...
        js1='document.getElementById("tab1").click()'   #全部　
        driver.execute_script(js1)
        time.sleep(20)
        driver.get_screenshot_as_file(r'F:\python_work\CINTEL_FZweb3_1_1\case\Prevent_situations\result\1_inter_top10.jpg')
        file_path = r"F:\python_work\CINTEL_FZweb3_1_1\case\Prevent_situations\result\1_inter_top10.jpg"
        image = Image.open(file_path)
        print(image.size)
        image_list = cut_image_operator(image, box=(566, 365, 1050, 720))
        save_images(image_list, index="国内拦截top10.jpg")

        sql="""
               	(select sum(fri.intercept_count_today) value,drd.reg_dim_id countrycode,drd.city_name name
                    from dim_date d  left join fact_region_intercept fri  on  d.date_dim_id=fri.date_dim_id
                ...
                and d.day_caption <"%s"
                    ...
                    GROUP BY drd.city_name  order by sum(fri.intercept_count_today) desc) limit 10;
        """%(his_time,start_tim)
    ...
    def test_operator(self):
        ...
        driver.get_screenshot_as_file(r'F:\python_work\CINTEL_FZweb3_1_1\case\Prevent_situations\result\2_operator.jpg')
        file_path = r"F:\python_work\CINTEL_FZweb3_1_1\case\Prevent_situations\result\2_operator.jpg"
        image = Image.open(file_path)
        print(image.size)
        image_list = cut_image_operator(image, box=(600,161,737,260))
        save_images(image_list, index="国内拦截电信总拦截数.jpg")
